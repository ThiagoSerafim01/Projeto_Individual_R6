...
*/
  ...
  if (fortificador.test(senha)) {
    ...
    spanAviso.innerHTML = `<span class="spanAviso">A Senha deve ter no minimo 8 caracteres:<br>Uma letra Maiúscula<br>Uma letra Minuscula<br>Um numero<br>Um caracter especial</span>`;
  }
}
